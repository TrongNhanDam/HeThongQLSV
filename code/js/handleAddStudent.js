const btn_addStudent = document.querySelector('#btn-addStudent');
btn_addStudent.addEventListener("click", (e) => {
    e.preventDefault();
    ...
    axios.post("../admin/php/intermediateAddStudent.php", JSON.stringify({
        ...
        .then((Response) => {
            ...
            if (Response.data == true) {
                swal({
                    title: "Success",
                    text: "Bạn đã thêm sinh viên thành công!",
                    icon: "success",
                    button: "OK!",
                });
                return
                ...
                swal({
                    title: "Ops!",
                    text: "Mã số sinh viên này đã tồn tại!",
                    icon: "error",
                    button: "Nhập lại!",
                });
